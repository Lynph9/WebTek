<?php
// InfinityFree uyumlu login sistemi
session_start();

// Doğru kullanıcı bilgileri
$valid_credentials = array(
    'b241210385@sakarya.edu.tr' => 'b241210385',
    // Test için ek kullanıcılar (isteğe bağlı)
    'b211210001@sakarya.edu.tr' => 'b211210001',
    'b211210002@sakarya.edu.tr' => 'b211210002'
);
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Sakarya domain kontrolü
    if (strpos($email, '@sakarya.edu.tr') === false) {
        header('Location: login.html?error=email');
        exit;
    }
    ...
    // Kullanıcı kontrolü
    $login_success = false;
    foreach ($valid_credentials as $valid_email => $valid_pass) {
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item"><a class="nav-link" href="index.html"><i class="fas fa-home me-1"></i>Hakkında</a></li>
                    <li class="nav-item"><a class="nav-link" href="cv.html"><i class="fas fa-graduation-cap me-1"></i>Eğitim</a></li>
                    <li class="nav-item"><a class="nav-link" href="sehrim.html"><i class="fas fa-map-marker-alt me-1"></i>Şehrim</a></li>
                    <li class="nav-item"><a class="nav-link" href="mirasimiz.html"><i class="fas fa-landmark me-1"></i>Mirasımız</a></li>
                    <li class="nav-item"><a class="nav-link" href="ilgi-alanlari.html"><i class="fas fa-heart me-1"></i>İlgi Alanları</a></li>
                    <li class="nav-item"><a class="nav-link active" href="login.html"><i class="fas fa-sign-in-alt me-1"></i>Giriş</a></li>
                    <li class="nav-item"><a class="nav-link" href="iletisim.html"><i class="fas fa-envelope me-1"></i>İletişim</a></li>
                </ul>
            </div>
        </div>
    </nav>
            ...
            <div class="col-md-8">
                <div class="card shadow-lg border-success">
                    <div class="card-header bg-success text-white text-center">
                        <h1 class="h3 mb-0"><i class="fas fa-check-circle me-2"></i>Giriş Başarılı!</h1>
                    </div>
                    <div class="card-body text-center">
                        ...
                        <div class="alert alert-success">
                            <h5 class="alert-heading"><i class="fas fa-info-circle me-2"></i>Giriş Bilgileri</h5>
                            <hr>
                        ...
                        <div class="row text-start">
                            <div class="col-md-6">
                                <h6 class="text-primary"><i class="fas fa-globe me-2"></i>Site Bölümleri</h6>
                            ...
                            <div class="col-md-6">
                                <h6 class="text-primary"><i class="fas fa-heart me-2"></i>İlgi Alanları & İletişim</h6>
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="logout_infinity.php" class="text-decoration-none text-danger">🚪 Çıkış Yap</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="card-footer bg-light text-center">
                        <small class="text-muted">
                            <i class="fas fa-shield-alt me-1"></i>Güvenli giriş gerçekleştirildi
                        </small>
                    </div>
                </div>
            </div>
